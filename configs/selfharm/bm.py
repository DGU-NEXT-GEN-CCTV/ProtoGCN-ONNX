modality = 'bm'
graph = 'coco_new'
work_dir = f'./work_dirs/selfharm/bm'
...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='coco_new', num_classes=2, in_channels=384, weight=0.3))

dataset_type = 'PoseDataset'
ann_file = './data/selfharm/dataset_selfharm.pkl'
